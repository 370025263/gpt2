...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(train_dataset, batch_size=12, shuffle=True, num_workers=-1)
    val_loader = DataLoader(val_dataset, batch_size=12, shuffle=False, num_workers=-1)
